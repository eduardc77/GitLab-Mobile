...
@MainActor
@Observable
public final class UserProjectsStore {
    // MARK: - Types
    public enum Scope: Equatable, Sendable { case owned, membership, starred, combined }
    private typealias Phase = LoadPhase
    private struct QueryContext: Equatable, Hashable, Sendable { let scope: Scope; let query: String? }
    private enum LoadEvent: Equatable, Sendable { case initial, refresh, contextChanged(QueryContext), search(String) }
