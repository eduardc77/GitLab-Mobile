...
public final class ExploreProjectsStore {
    // MARK: - Types
    private enum LoadEvent: Equatable, Sendable { case initial, refresh, sortChanged(SortContext), search(String) }
    private typealias Phase = LoadPhase
    private struct SortContext: Equatable, Hashable, Sendable {
        let query: String?
        let sortBy: ProjectSortField
...
// Mapping moved to enum extensions in Domain/Models
