...
public protocol IssueRepository: Sendable {
    ...
    func issues(for projectId: Int) async throws -> [Issue]

    /// Fetch a specific issue
    func issue(id: Int, in projectId: Int) async throws -> Issue

    /// Create a new issue
    func createIssue(_ issue: IssueCreateRequest, in projectId: Int) async throws -> Issue

    /// Update an existing issue
    func updateIssue(id: Int, with update: IssueUpdateRequest, in projectId: Int) async throws -> Issue
